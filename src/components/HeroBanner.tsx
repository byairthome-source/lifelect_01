  ...
  return (
    <section className="fixed inset-0 z-0 flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        <h1 className="animate-[fade-up_0.8s_ease-out_forwards] opacity-0 text-white font-bold text-5xl md:text-7xl lg:text-[80px] leading-[1.1] mb-6 tracking-tight [text-shadow:0_4px_24px_rgba(0,0,0,0.6)]">
        ...
        <div className="animate-[fade-up_0.8s_ease-out_forwards] opacity-0" style={{ animationDelay: "0.5s" }}>
          <Link
            href="/products"
